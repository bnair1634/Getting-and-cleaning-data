...
The code book includes information about the source data, the analysis performed after collecting the data and informations about variables of the resulting data sets.

Study Design

The source data was collected from the UCI Machine Learning Repository to complete an assignment Getting and Cleaning Data. The assignment involved working with the data set and producing tidy data representation of the source data. Below is a list of the operations done to achieve the outputs.
